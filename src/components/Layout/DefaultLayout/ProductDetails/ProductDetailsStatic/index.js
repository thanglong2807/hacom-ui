                    ...
                    <div className={cx('store-list-group-2022')}>
                        ...
                        <div className={cx('store-list')}>
                            <div className={cx('item')} data-erp="Ton101">
                                <Link to="/hacom-ui" target="_blank" title="131 Lê Thanh Nghị - Hai Bà Trưng - Hà Nội">
                            ...
                            <div className={cx('item')} data-erp="Ton102">
                                <Link to="/hacom-ui" target="_blank" title="43 Thái Hà - Đống Đa - Hà Nội">
                                    <span className={cx('red')}>
                            ...
                            <div className={cx('item')} data-erp="Ton103">
                                <Link to="/hacom-ui" target="_blank" title="406 Tô Hiệu - Lê Chân - Hải Phòng">
                                    <span className={cx('red')}>
                            ...
                            <div className={cx('item')} data-erp="Ton104">
                                <Link to="/hacom-ui" target="_blank" title="79 Nguyễn Văn Huyên - Cầu Giấy - Hà Nội">
                                    <span className={cx('red')}>
                            ...
                            <div className={cx('item')} data-erp="Ton105">
                                <Link to="/hacom-ui" target="_blank" title="511 Quang Trung - Hà Đông - Hà Nội">
                                    <span className={cx('red')}>
                            ...
                            <div className={cx('item')} data-erp="Ton106">
                                <Link to="/hacom-ui" target="_blank" title="520 Cách Mạng Tháng 8 - Quận 3 - TP HCM">
                                    <span className={cx('red')}>
                            ...
                            <div className={cx('item')} data-erp="Ton107">
                                <Link to="/hacom-ui" target="_blank" title="398 Nguyễn Văn Cừ - Long Biên - Hà Nội">
                                    <span className={cx('red')}>
                            ...
                            <div className={cx('item')} data-erp="Ton112">
                                <Link to="/hacom-ui" target="_blank" title="CT4A Bắc Linh Đàm - Hoàng Mai - Hà Nội">
                                    <span className={cx('red')}>
                            ...
                            <div className={cx('item')} data-erp="Ton113">
                                <Link to="/hacom-ui" target="_blank" title="77 Cao Lỗ - Đông Anh - Hà Nội">
                                    <span className={cx('red')}>
                            ...
                            <div className={cx('item')} data-erp="Ton114">
                                <Link to="/hacom-ui" target="_blank" title="57 Trần Phú - Hà Đông - Hà Nội">
                                    <span className={cx('red')}>
                            ...
                            <div className={cx('item')} data-erp="Ton116">
                                <Link to="/hacom-ui" target="_blank" title="136 Lê Hoàn - Quốc Lộ 1A - Phủ Lý - Hà Nam">
                                    <span className={cx('red')}>
                            ...
                            <div className={cx('item')} data-erp="Ton118">
                                <Link
                                    to="/hacom-ui"
                                    target="_blank"
                                    title="126 Lương Ngọc Quyến - Quang Trung - Thái Nguyên"
                                >
                                    <span className={cx('red')}>
                            ...
                            <div className={cx('item')} data-erp="Ton119">
                                <Link to="/hacom-ui" target="_blank" title="Số 6 Trần Phú - Điện Biên - Thanh Hóa">
                                    <span className={cx('red')}>
                            ...
                            <div className={cx('item')} data-erp="Ton120">
                                <Link
                                    to="/hacom-ui"
                                    target="_blank"
                                    title="500 Nguyễn Thị Thập - Quận 7 - TP. Hồ Chí Minh"
                                >
                                    <span className={cx('red')}>
